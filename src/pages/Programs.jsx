...
const programs = [
  {
    ...
    description: 'A structured mentorship program designed to help BAMS students build confidence, develop a strong Ayurvedic identity, and navigate their academic and professional journey with clarity.',
  ...
  },
  {
    ...
    description: 'Empowering working women to reclaim balance, build emotional resilience, and achieve holistic well-being through the timeless wisdom of Ayurveda.',
    link: '/programs/women',
  },
  {
    icon: '💼',
    ...
    description: 'A transformative program for corporate professionals seeking to enhance leadership, manage stress, and build strategic intelligence through Ayurvedic cognitive science.',
